...
namespace CBTBehaviorsEnhanced
{
    public class ModText
    {
        ...
        public const string LT_Label_DFA_Base_Attack_Mod = "ATK_MOD_DFA_BASE_MOD";
        ...
        public void InitUnsetValues()
        {
            ...
            if (this.Labels.Count == 0)
            {
                this.Labels = new Dictionary<string, string>
                {
                    ...
                    { LT_Label_DFA_Attack_Mod, "DFA ATTACKER MOD" },
                    { LT_Label_DFA_Base_Attack_Mod, "DFA TYPE MOD" },
