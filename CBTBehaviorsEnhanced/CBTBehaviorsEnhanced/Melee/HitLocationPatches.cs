...
namespace CBTBehaviorsEnhanced.Patches.Melee
{
    ...
    public static class CombatGameConstants_OnDataLoaded
    {
        ...
        static void Postfix(CombatGameConstants __instance, string id, string json)
        {
            try
            {
                ...
                PUNCH_vehicle_table.ParentStructureId = "vehicle";
                PUNCH_vehicle_table.Id = $"CBTBE_MELEE_{DamageTable.PUNCH.ToString()}";
